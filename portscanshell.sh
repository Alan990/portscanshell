...
echo -e "\t\t[1] Para Analize de um IP\n"
echo -e "\t\t[2] Para Analize de um dominio\n"
echo -e "\t\t[3] Para Analize de um ranges de IPs\n"
echo -e "\t\t[4] Para Ver Somente as Portas Abertas\n"
echo -e "\t\t[5] Analize de Portas Específicas\n"
echo -e "\t\t[6] Para Scanear Alvos Dentro de um Arquivo.txt\n"
echo -e "\t\t[7] Analizar o Sistema Operacional do Alvo\n"
echo -e "\t\t[8] Analizar a Versão do serviço que está rodando nas P. Abertas\n"
echo -e "\t\t[9] Analizar portas mais utilizadas usando TCP SYN\n"
